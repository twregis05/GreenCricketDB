            ...
            {filtered.map((c) => (
              ...
              >
                ...
                <div className="client-info">
                  <h3 className="client-name">{c.firstName} {c.lastName}</h3>
                  {c.phone && <p className="client-detail">{c.phone}</p>}
                  {c.email && <p className="client-detail">{c.email}</p>}
                  {c.address && <p className="client-detail client-addr">{c.address}</p>}
                </div>
                {c.invoicePending && (
